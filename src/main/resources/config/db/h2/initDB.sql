DROP SEQUENCE IF NOT EXISTS hibernate_sequence
CREATE SEQUENCE  hibernate_sequence START WITH 1 INCREMENT BY 1;

DROP TABLE IF EXISTS phone;
CREATE MEMORY TABLE phone
(
  phone_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) ,
...
(
  category_id BIGINT  GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) ,
